...
const DashboardPage = () => {
  ...
  return (
    <div className="min-h-screen flex bg-background">
      {/* Left side gray, always visible and wider */}
      <div className="w-1/6 bg-gray-100 border-r border-gray-200" />
      {/* Main content centered with padding */}
      <div className="flex-1 flex justify-center items-start py-6 sm:py-8">
      ...
      {/* Right side gray, always visible and wider */}
      <div className="w-1/6 bg-gray-100 border-l border-gray-200" />
    </div>
  );
};
